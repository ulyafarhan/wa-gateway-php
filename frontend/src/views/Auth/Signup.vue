        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            ...
            <div>
              ...
              <div v-if="success" class="rounded-lg bg-emerald-500/10 border border-emerald-500/20 px-4 py-3 text-sm text-emerald-500 mb-4">Account created! Redirecting to login...</div>
              ...
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  <div>
                    ...
                    <input v-model="username" type="text" id="username" placeholder="Choose a username" autocomplete="username"
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input v-model="password" :type="showPassword ? 'text' : 'password'" id="password" placeholder="Min 8 characters" autocomplete="new-password"
